...
export async function GET(request) {
  try {
    ...
    const q = query(
      collection(db, "emergency_funds_transaction"),
      where("userId", "==", userId)
    );
...
export async function POST(request) {
  try {
    ...
    // Add the transaction to the "emergency_funds_transaction" collection
    const docRef = await addDoc(collection(db, "emergency_funds_transaction"), {
