...
export async function GET(request) {
  try {
    ...
    const q = query(
      collection(db, "leisure_funds_transaction"),
      where("userId", "==", userId)
    );
...
export async function POST(request) {
  try {
    ...
    // Add the transaction to the "leisure_funds_transaction" collection
    const docRef = await addDoc(collection(db, "leisure_funds_transaction"), {
